...
- 🤖 [**telecom-ai-assistant**](https://github.com/Kavi274/telecom-ai-assistant) — AI-powered telecom analytics dashboard with churn prediction, forecasting, and a Llama 3 chatbot
- 🎬 [**movie-recommendation-system-data-engineering-pipeline**](https://github.com/Kavi274/movie-recommendation-system-data-engineering-pipeline) — End-to-end data engineering pipeline with AWS S3 and Python ETL
- 💳 [**credit-card-fraud-detection-ml**](https://github.com/Kavi274/credit-card-fraud-detection-ml) — Fraud detection using classification algorithms
- 📄 [**resume-screening-ai**](https://github.com/Kavi274/resume-screening-ai) — AI-driven resume screening tool
